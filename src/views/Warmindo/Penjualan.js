...
function Penjualan() {
  ...
  const [nama, setPenjualan] = React.useState("");
  ...
  return (
    <Container fluid>
      ...
      <Row>
        <Col md="12" >
            <Card.Header>
                <Card.Title as="h4">List Penjualan <Button className="btn-wd mr-1" variant="primary" style={{marginLeft:25}} onClick={() => setModal(!modal)}>
                        Export
                      </Button></Card.Title>
            </Card.Header>
            <Card.Body>
